...
import dwarf.item.tool.radiy.RadiyShovelItem;
...
public class DwarfTools {
    ...
    public static final ToolItem RADIY_SWORD =add("radiy_sword",new RadiySwordItem(RadiyMaterial.RADIY_MATERIAL,1,1f,settings()));
    public static final ToolItem RADIY_PICKAXE =add("radiy_pickaxe",new RadiyPickaxeItem(RadiyMaterial.RADIY_MATERIAL,0,0f,settings()));
    public static final ToolItem RADIY_SHOVEL =add("radiy_shovel",new RadiyShovelItem(RadiyMaterial.RADIY_MATERIAL,0,0f,settings()));
